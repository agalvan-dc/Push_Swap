...
### 1. Simple Sort (Para inputs pequeños: $\le 5$ elementos)
...
* **Justificación:** A pesar de su complejidad teórica $O(n^2)$, para tamaños de muestra tan reducidos, el sobrecoste de indexación de algoritmos avanzados gastaría más operaciones de las necesarias. Garantiza la ordenación de 3 elementos en $\le 3$ operaciones y de 5 elementos en $\le 12$ operaciones.

### 2. Chunk Sort (Para inputs medianos: $\approx 100$ elementos)
...
### 3. Ksort / Algoritmo Adaptativo avanzado (Para inputs grandes: $\ge 500$ elementos)
